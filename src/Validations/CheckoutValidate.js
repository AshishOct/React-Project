...
export default function checkoutValidate(data) {
  ...
  // if (validator.isEmpty(data.billing_company_name)) {
  //    errors.billing_company_name = 'This field is required';
  // }  
  ...
  // if (validator.isEmpty(data.billing_address_2)) {
  //    errors.billing_address_2 = 'This field is required';
  // }
  ...
  if(data.ship_to_different_address=="checked") {
      ...
      // if (validator.isEmpty(data.shipping_company_name)) {
      //    errors.shipping_company_name = 'This field is required';
      // }  
      ...
      // if (validator.isEmpty(data.shipping_address_2)) {
      //    errors.shipping_address_2 = 'This field is required';
      // }
